...
def main():
    ...
    service_quotas_to_be_validated = ServiceQuotasHelper.get_aws_service_quota_to_be_validated(service_quota_file)
    # Service Quota dictionary used to hold all collected data
    sq = service_quota_helper.validate_aws_service_quotas(service_quotas_to_be_validated,num_az = num_az)
