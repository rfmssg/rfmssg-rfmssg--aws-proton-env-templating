...
resource "aws_subnet" "master1" {
  ...
  tags = {
    "Name" : join("-", [var.network_tag_prefix, "cosaws-public-subnet", var.availability_zone1])
  }
}
resource "aws_subnet" "master2" {
  ...
  tags = {
    "Name" : join("-", [var.network_tag_prefix, "cosaws-public-subnet", var.availability_zone2])
  }
}
resource "aws_subnet" "master3" {
  ...
  tags = {
    "Name" : join("-", [var.network_tag_prefix, "cosaws-public-subnet", var.availability_zone3])
  }
}
...
resource "aws_subnet" "worker1" {
  ...
  tags = {
    "Name" : join("-", [var.network_tag_prefix, "cosaws-private-subnet", var.availability_zone1])
  }
}
resource "aws_subnet" "worker2" {
  ...
  tags = {
    "Name" : join("-", [var.network_tag_prefix, "cosaws-private-subnet", var.availability_zone2])
...
resource "aws_subnet" "worker3" {
  ...
  tags = {
    "Name" : join("-", [var.network_tag_prefix, "cosaws-private-subnet", var.availability_zone3])
  }
}
